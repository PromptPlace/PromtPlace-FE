...
const primaryButtonTheme = {
  buttonType: {
    ...
    square:
      'rounded-[12px] py-[12px] px-[20px] border-[0.8px] max-lg:rounded-[4px] max-lg:border-[0.5px] max-lg:text-[10px] max-lg:font-normal max-lg:leading-[13px] max-lg:tracking-[0.46px] max-lg:py-[6.5px]',
    squareMini:
  ...
  return (
    <button
      ...
      className={clsx(
        ...
        isReviewDelete
          ? 'border-alert text-alert text-sm leading-[18px]'
          : 'border-primary hover:border-primary-hover active:border-primary-pressed text-primary hover:text-primary-hover active:text-primary-pressed active:bg-secondary',
