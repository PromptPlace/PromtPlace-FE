...
import { MobileImageList } from './ImageList';
              ...
              <div className="flex flex-col items-center">
                <div className="w-full max-w-[90%] h-[24px] flex justify-between items-center mb-[10px] mx-[20px] ">
                  <label className="flex items-center">
                    ...
                    <input
                      type="checkbox"
                      className="w-[12px] h-[12px] accent-primary-pressed  ml-[12px] border-text-on-background hidden"
                      checked={withImage}
                      onChange={(e) => {
                    ...
                    />
                    {withImage ? (
                      <img className="w-[12px] h-[12px] ml-[12px]" src={checkbox} alt="박스임" />
                    ) : (
                      <img className="w-[12px] h-[12px] ml-[12px]" src={box} alt="박스임" />
                    )}
                  </label>
                  {/* 체크박스가 체크된 경우에만 업로드 버튼 표시 */}
                  {withImage ? (
                    <IconButton
                ...
                <div className="w-full max-w-[90%] flex flex-col mx-[20px]">
                  ...
                  <div className="w-full min-w-[280px] h-[125px]  mt-[8px] py-[6px] px-[6px] bg-background rounded-[2px] flex flex-col gap-2">
                    ...
                    <textarea
                      ...
                      className="w-full min-h-[40px] max-h-[110px] flex-1 bg-transparent outline-none resize-none text-[10px]
                     placeholder:text-text-on-background placeholder:text-[10px] overflow-y-auto"
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="mx-[20px] my-[20px]">
                ...
                <div className="mt-[8px] px-[6px] py-[6px] bg-background rounded-[2px] h-[140px]">
                  <textarea
                    ...
                    className="w-full h-full bg-transparent outline-none resize-none text-[10px] placeholder:text-text-on-background placeholder:text-[10px] "
                  />
                </div>
              </div>
            </>
