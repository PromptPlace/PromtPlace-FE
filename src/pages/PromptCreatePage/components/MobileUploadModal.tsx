            ...
            <div className="flex flex-col items-center">
              <div className="w-full max-w-[80%] h-[24px] flex justify-between items-center my-[20px] mx-[20px] ">
                <label className="flex items-center">
                  ...
                  <input
                    type="checkbox"
                    className="w-[12px] h-[12px] accent-blue-600  ml-[12px] border-text-on-background"
                    checked={withImage}
                    onChange={(e) => {
              ...
              <div className="w-full max-w-[80%] flex flex-col mx-[20px]">
                ...
                <div className="w-full min-w-[280px] h-[125px]  mt-[8px] py-[6px] px-[6px] bg-background rounded-[2px] flex flex-col gap-2">
                  ...
                  <textarea
                    ...
                    className="w-full min-h-[40px] max-h-[110px] flex-1 bg-transparent outline-none resize-none
                     placeholder:text-text-on-background text-[10px] overflow-y-auto"
                  />
                </div>
              </div>
            </div>
