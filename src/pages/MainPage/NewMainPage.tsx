...
const NewMainPage = () => {
  ...
  const { data: normalData, isPending: isNormalDataPending } = useGetPromptList();

  const { data: searchData, isPending: isSearchDataPending } = useGetSearchPromptList(
    {
    ...
    <div className="max-mypage:pl-[40px] max-phone:pl-[20px] pl-[102px] ">
      ...
      <div className="mt-[56px] pr-[102px] max-phone:pr-[20px] max-mypage:pr-[40px]">
        ...
        <div className="max-phone:hidden overflow-x-scroll hide-scrollbar">
          <PromptGrid prompts={paginatedPrompts} isPending={isSearchDataPending || isNormalDataPending} />
        </div>
