...
const UploadPrompt = () => {
  return (
    <div className="flex w-full px-[40px] pt-[64px] gap-[40px]">
      ...
      <section className="flex flex-col gap-[20px]">
        <div className="flex gap-[20px] px-[20px] py-[16px] bg-gray-50 rounded-[12px] w-[390px] h-[154px]">
        ...
        <div className="flex gap-[20px] px-[20px] py-[16px] bg-gray-50 rounded-[12px] w-[390px] h-[154px]">
          ...
          <img src={imageResult} alt="Image Result Example" className="w-[165px] h-[122px] mt-[12px] rounded-[8px]" />
        </div>
      </section>
    </div>
  );
