...
const ImageBox = ({ url, to }: ImageBoxProps) => {
  ...
  return (
    <>
      <div
        onClick={() => navigate(to)}
        className="relative image-overlay w-[482px] max-lg:w-[282px] max-phone:w-[175px]! aspect-[16/9] rounded-[15px] overflow-hidden relative self-center m-auto cursor-pointer whitespace-nowrap">
