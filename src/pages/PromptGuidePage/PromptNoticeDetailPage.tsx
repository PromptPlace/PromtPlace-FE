    ...
    <>
      <div className="hidden min-[1026px]:block">
        <div className="mt-[64px] mb-[20px] mx-[102px]">
          <span
            className="w-[65px] flex justify-center gap-[4px] cursor-pointer"
            onClick={() => {
              navigate('/guide/notice');
            }}>
            <p className="text-[14px] font-light text-text-on-white">공지사항</p>
            <img src={rightArrow} alt="뒤로 가기" />
          </span>
        </div>
        <div className="min-h-[672px] flex flex-col items-center mx-[102px] rounded-[12px] bg-white pt-[56px] px-[80px] pb-[32px]">
                  ...
                  <div>
                    <div className="flex items-center gap-[12px] h-[17px]">
                      ...
                      <div>
                        ...
                        <span className="text-[12px] font-light text-gray500">{post.created_at}</span>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div className="flex flex-col items-center mx-[20px] rounded-[12px] bg-white pt-[32px] px-[20px] pb-[20px]">
          <div className="w-full ">
            ...
            <div className="flex justify-end items-end">
              {post.file_url ? (
                <div className="w-[83px] h-[32px] gap-[8px] flex mt-[32px] border border-gray400 rounded-[8px] items-center justify-center cursor-pointer">
                  <p className="text-[12px] font-light text-gray700">첨부파일</p>
                  <img src={attachFile} alt="첨부 파일" className=" w-[20px] h-[20px]" />
                </div>
              ) : (
...
export default PromptNoticeDetailPage;
