...
const SellerCancelModal = ({ sellerName, isSubmitting, onClose, onConfirm }: SellerCancelModalProps) => {
  return (
    <div className="rounded-2xl px-8 py-10 w-[940px] h-[213px] bg-white">
      <div className="flex text-center justify-center text-2xl">{sellerName}님의 판매자 등록을 취소하겠습니까?</div>
