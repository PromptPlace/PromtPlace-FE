...
const PromptCard = ({ id, title, model, tags, isMyProfile }: PrompCardProps) => {
  ...
  return (
    <div className="bg-white border-b border-b-white-stroke py-[10px] flex justify-between items-center cursor-pointer">
      <div
        ...
        className="text-text-on-white text-[22px] font-bold leading-[28px] py-[20px] px-[80px] truncate max-w-[664px] truncate">
        {title}
      </div>
      ...
      {isMyProfile && (
        <div
          ...
          className="relative py-[22px] px-[44px] cursor-pointer w-[115px] h-[72px] flex items-center justify-center">
          ...
          {isDotsClicked && (
            <div className="absolute z-10 top-[60px] right-[44px] flex flex-col whitespace-nowrap">
              <button className="py-[8px] px-[16px] bg-secondary rounded-t-[4px] border-b border-b-white-stroke text-text-on-background text-[16px] font-normal leading-[20px] active:bg-secondary-pressed active:text-text-on-white">
                삭제하기
              </button>
              <button className="py-[8px] px-[16px] bg-secondary rounded-b-[4px] text-text-on-background text-[16px] font-normal leading-[20px] active:bg-secondary-pressed active:text-text-on-white">
                수정하기
              </button>
            </div>
          )}
